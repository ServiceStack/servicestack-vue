...
<div class="font-mono">
    <div v-if="!disabled" class="border border-gray-200 flex justify-between">
        <div class="p-2 flex flex-wrap gap-x-4">
            <svg :class="btnCls" @click="bold" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Bold text (CTRL+B)</title>
            ...
            <svg :class="btnCls" @click="italic" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Italics (CTRL+I)</title>
                <path fill="currentColor" d="M10 4v3h2.21l-3.42 8H6v3h8v-3h-2.21l3.42-8H18V4h-8z" />
            </svg>
            <svg :class="btnCls" @click="link" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Insert Link (CTRL+K)</title>
            ...
            <svg :class="btnCls" @click="quote" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Blockquote (CTRL+Q)</title>
                <path fill="currentColor" d="m15 17l2-4h-4V6h7v7l-2 4h-3Zm-9 0l2-4H4V6h7v7l-2 4H6Z" />
            </svg>
            <svg :class="btnCls" @click="image" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Insert Image (CTRL+SHIFT+L)</title>
            ...
            <svg :class="btnCls" @click="code" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Insert Code (CTRL+&lt;)</title>
            ...
            <svg :class="btnCls" @click="heading" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>H2 Heading (CTRL+H)</title>
                <path fill="currentColor" d="M7 20V7H2V4h13v3h-5v13H7Zm9 0v-8h-3V9h9v3h-3v8h-3Z" />
            </svg>
            <svg :class="btnCls" icon @click="ol" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Numbered List (ALT+1)</title>
            ...
            <svg :class="btnCls" @click="ul" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Bulleted List (ALT+-)</title>
            ...
            <svg :class="btnCls" @click="strikethrough" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Strike Through (ALT+S)</title>
                <path fill="currentColor" d="M10 19h4v-3h-4v3zM5 4v3h5v3h4V7h5V4H5zM3 14h18v-2H3v2z" />
            </svg>
            <svg :class="btnCls" @click="undo" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Undo (CTRL+Z)</title>
            ...
            <svg :class="btnCls" @click="redo" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Redo (CTRL+SHIFT+Z)</title>
            ...
            <svg :class="btnCls" @click="save" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Save (CTRL+S)</title>
        ...
        <div class="p-2 flex flex-wrap gap-x-4">
            <a title="formatting help" target="_blank"
...
const cls = computed(() => ['shadow-sm ' + input.base.replace('rounded-md',''), errorField.value 
...
const quote = () => insert('\n> ', '\n', 'Blockquote', {})
const image = () => insert('![', '](https://)', 'alt text', { offsetStart: -9, offsetEnd: 8 })
