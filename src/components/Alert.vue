...
<div :class="[backgroundColor, borderColor, 'border-l-4 p-4']">
    <div class="flex">
        <div class="flex-shrink-0">
            ...
            <svg v-else-if="type=='Information'" class="h-5 w-5 text-blue-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
const backgroundColor = computed(() => props.type == "Information"
...
const borderColor = computed(() => props.type == "Information"
    ? "border-blue-400"
    : props.type == "Error"
    ? "border-red-400"
    : props.type == "Success"
...
const textColor = computed(() => props.type == "Information"
    ? "text-blue-700"
    : props.type == "Error"
    ? "text-red-700"
    : props.type == "Success"
